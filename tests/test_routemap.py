...
set_statements = [
    ...
    'set community 65000:22',
    'set community 65000:22 1234 local-AS',
    'set community 65000:36000',
    'set community 65000:36000 1234 local-AS',
...
# def test_both_a_match_and_a_set():
#     for m,s in itertools.product(match_statements, set_statements):
#         route_map = '{}\n {}\n {}'.format(route_map_prolouge, m, s)
#         try:
#             tokens = routeMapParser.parseString(route_map)
#         except ParseException:
#             print "Route map:\n{}".format(route_map)
